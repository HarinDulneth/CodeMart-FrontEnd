    ...
    <footer ref={footerRef} className="relative">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-white/95">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/projects" className="text-white/75 hover:text-white transition-colors">
                  Browse Projects
                </Link>
              </li>
              <li>
                <Link to="/sell" className="text-white/75 hover:text-white transition-colors">
                  Sell Project
                </Link>
              </li>
              <li>
                <Link to="/profile" className="text-white/75 hover:text-white transition-colors">
                  My Profile
                </Link>
              </li>
            </ul>
          ...
          {/* Support */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-white/95">Support</h3>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-white/75 hover:text-white transition-colors">
                  Help Center
          ...
          {/* Developers */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-white/95">Developers</h3>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="text-center">
              <h4 className="text-lg font-semibold mb-4 text-white/95">Join Our Community</h4>
            ...
            <div className="text-center">
              <h4 className="text-lg font-semibold mb-4 text-white/95">Start Selling Today</h4>
              <p className="text-[#b9b9b9] text-sm">
                Turn your code into cash. List your projects and start earning from your development work.
              </p>
            </div>
            <div className="text-center">
              <h4 className="text-lg font-semibold mb-4 text-white/95">Quality Assured</h4>
              <p className="text-[#b9b9b9] text-sm">
